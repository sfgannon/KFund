function $_global_clientpeoplepicker() {
    ...
    SPClientPeoplePicker.prototype = {
        ...
        SetInitialValue: function(b, d) {
            ...
            EnsureScript("autofill.js", c, function() {
                ...
                d != null && a.ShowErrorMessage(d);
                a.EnsureAutoFillControl()
            })
        },
            ...
            EnsureScript("SP.js", b, function() {
                ...
                if (d) {
                    ...
                    EnsureScript("autofill.js", b, function() {
                        ...
                        var c = document.getElementById(a.EditorElementId);
                        c.value = e;
                        var b = a.AddPickerSearchQuery(e);
                        a.ExecutePickerQuery([b], function(e, c) {
                            if (c == null || b != e)
                                return;
                    ...
                    a.BatchAddUserKeysOperation(f, 0)
            })
        },
        ...
        GetPeoplePickerQueryParameters: function() {
            a: ;var a = new SP.UI.ApplicationPages.ClientPeoplePickerQueryParameters;
            a.set_required(!this.AllowEmpty);
            a.set_forceClaims(this.ForceClaims);
            a.set_allowMultipleEntities(this.AllowMultipleUsers);
            a.set_allowEmailAddresses(this.AllowEmailAddresses);
            a.set_allUrlZones(this.AllUrlZones);
            a.set_enabledClaimProviders(this.EnabledClaimProviders);
            a.set_maximumEntitySuggestions(this.MaximumEntitySuggestions);
            a.set_sharePointGroupID(this.SharePointGroupID);
            a.set_webApplicationID(this.WebApplicationID);
            a.set_principalType(SPClientPeoplePicker.CreateSPPrincipalType(this.PrincipalAccountType));
            a.set_urlZoneSpecified(this.UrlZone != null );
            a.set_urlZone(this.UrlZone != null ? this.UrlZone : 0);
            return a
        },
        ExecutePickerQuery: function(c, f, e, b) {
            ...
            var g = false
              , i = setTimeout(function() {
                ...
                for (var c in a.UserQueryDict)
                    delete a.UserQueryDict[c];
                b != null && b()
        ...
        OnControlValueChanged: function() {
            ...
            this.OnValueChangedClientScript != null && this.OnValueChangedClientScript(this.TopLevelElementId, this.GetAllUserInfo())
        },
        OnControlResolvedUserChanged: function() {
            a: ;this.SaveAllUserKeysToHiddenInput();
            this.ValidateCurrentState();
            this.OnUserResolvedClientScript != null && this.OnUserResolvedClientScript(this.TopLevelElementId, this.GetAllUserInfo())
        },
        EnsureAutoFillControl: function() {
            a: ;if (this.AutoFillEnabled && this.AutoFillControl == null ) {
        ...
        ShowAutoFill: function(a) {
            if (a != null ) {
                var b = SPClientPeoplePicker_CallbackOnAutoFillClose;
                this.AutoFillControl.PopulateAutoFill(a, b);
        ...
        CloseAutoFill: function() {
            a: ;this.AutoFillControl != null && this.AutoFillControl.CloseAutoFill(null );
            RemoveEvtHandler(document.body.parentNode, "onclick", SPClientPeoplePicker_BodyOnClickCloseAutoFill)
        },
        IsAutoFillOpen: function() {
            a: ;return this.AutoFillControl != null && this.AutoFillControl.IsAutoFillOpen()
        },
        EnsureEditorWidth: function() {
            a: ;var b = document.getElementById(this.EditorElementId);
            if (b != null ) {
                var a = b.parentNode.clientWidth - 30;
                if (a <= 0)
                    a = 20;
                b.style.maxWidth = String(a) + "px"
            }
            this.EditorWidthSet = true
        },
        SetFocusOnEditorEnd: function() {
            a: ;var a = document.getElementById(this.EditorElementId);
            if (a != null ) {
        ...
        SaveAllUserKeysToHiddenInput: function() {
            a: ;var a = document.getElementById(this.HiddenInputId);
            if (a != null )
                a.value = this.GetControlValueAsText()
        },
        ...
        GetAllUserInfo: function() {
            a: ;var a = [];
            this.IterateEachProcessedUser(function(c, b) {
                if (b != null ) {
                    a.push(b.UserInfo);
        ...
        GetControlValueAsJSObject: function() {
            a: ;var b = this.GetAllUserInfo()
              , a = this.GetCurrentEditorValue();
            if (a == "")
                return b;
            var c = SPClientPeoplePicker.BuildUnresolvedEntity(a, a);
            b.push(c);
            return b
        },
        ...
        GetControlValueAsText: function() {
            a: ;var a = this.GetControlValueAsJSObject();
            for (var b in a) {
                if (typeof a[b].Claim != "undefined")
                    delete a[b].Claim;
                if (typeof a[b].EntityDataElements != "undefined")
                    delete a[b].EntityDataElements
            }
            return JSON.stringify(a)
        },
        IsEmpty: function() {
            a: ;var a = this.GetCurrentEditorValue();
        ...
        HasResolvedUsers: function() {
            a: ;return this.TotalUserCount - this.UnresolvedUserCount > 0
        },
        Validate: function() {
            a: ;if (!this.AllowEmpty && this.IsEmpty()) {
        ...
        ValidateCurrentState: function() {
            a: ;if (!this.AllowMultipleUsers && this.TotalUserCount > 1) {
                this.HasInputError = true;
        ...
        ClearServerError: function() {
            a: ;this.HasServerError = false;
            this.ValidateCurrentState()
        },
        SetServerError: function() {
            a: ;this.HasServerError = true;
        ...
        SetEnabledState: function(c) {
            ...
            if (c) {
                a.disabled = false;
                RemoveCssClassFromElement(b, "sp-peoplepicker-topLevelDisabled")
            } else {
                a.value = "";
                a.disabled = true;
                AddCssClassToElement(b, "sp-peoplepicker-topLevelDisabled")
            }
        ...
        DisplayLocalSuggestions: function() {
            ...
            if (a == null )
                return;
            this.HasServerError && this.ClearServerError();
            var d = a.value;
            this.CompileLocalSuggestions(d);
            ...
            if (b > 0) {
                ...
                !this.PlanningGlobalSearch() && this.CloseAutoFill()
        },
        CompileLocalSuggestions: function(a) {
            if (a == this.CurrentQueryStr)
                return;
        ...
        AddLoadingSuggestionMenuOption: function() {
            a: ;if (!this.ShowingLocalSuggestions() && !this.IsAutoFillOpen()) {
                this.ToggleWaitImageDisplay(true);
                return
            }
            var a = [];
            a.push(SPClientAutoFill.BuildAutoFillSeparatorMenuItem());
            a.push(SPClientAutoFill.BuildAutoFillLoadingSuggestionsMenuItem());
            this.ShowAutoFill(this.CurrentLocalSuggestions.concat(a))
        },
        ShowingLocalSuggestions: function() {
            a: ;return this.IsAutoFillOpen() && this.CurrentLocalSuggestions.length > 0
        },
        ShouldUsePPMRU: function() {
            a: ;return this.UseLocalSuggestionCache && this.UrlZone == null && this.SharePointGroupID <= 0 && this.WebApplicationID == "{00000000-0000-0000-0000-000000000000}" && (this.EnabledClaimProviders == "" || this.EnabledClaimProviders == null ) && this.PrincipalAccountTypeEnum % 2 == 1 && this.ResolvePrincipalSource == 15
        },
        AddResolvedUserToLocalCache: function(a, b) {
            if (a != null && b != null && b != "")
                this.ShouldUsePPMRU() && SPClientPeoplePicker.IsUserEntity(a) && this.PPMRU.SetItem(b, a)
        }
    };
    ...
    SPClientPeoplePicker.GetTopLevelControl = function(b) {
        ...
        while (a != null && a.nodeName.toLowerCase() != "body") {
            if (Boolean(a.getAttribute("SPClientPeoplePicker")))
                return a;
            a = a.parentNode
        }
        return null
    ...
    ;
    SPClientPeoplePicker.AugmentEntitySuggestions = function(d, a, h) {
        if (d == null || a == null || typeof a.length == "undefined")
            return [];
        for (var e = [], g = a.length, b = 0; b < g; b++) {
            var c = a[b]
              , f = "";
            if (c[SPClientPeoplePicker.ValueName] != null )
                f = c[SPClientPeoplePicker.ValueName];
            if (h && d.CurrentLocalSuggestionsDict[f.toLowerCase()] != null )
                continue;e.push(SPClientPeoplePicker.AugmentEntity(c))
        }
        return e
    }
    ;
    SPClientPeoplePicker.AugmentEntity = function(a) {
        var h = ""
          ...
          , d = ""
          , b = "";
        if (a[SPClientPeoplePicker.ValueName] != null )
            h = a[SPClientPeoplePicker.ValueName];
        if (a[SPClientPeoplePicker.DisplayTextName] != null )
            g = a[SPClientPeoplePicker.DisplayTextName];
        if (a.EntityData != null && a.EntityData[SPClientPeoplePicker.SubDisplayTextName] != null )
            f = a.EntityData[SPClientPeoplePicker.SubDisplayTextName];
        if (a[SPClientPeoplePicker.DescriptionName] != null )
            b = a[SPClientPeoplePicker.DescriptionName];
        var i = a.EntityData != null && a.EntityData.Email != null
          , e = i ? a.EntityData.Email : ""
          , c = a.ProviderDisplayName != null ? a.ProviderDisplayName : "";
        d = e != "" && c != "" ? e + "\n" + c : e + c;
        if (Boolean(b))
            d += "\n" + b;
        a[SPClientPeoplePicker.KeyProperty] = h;
        a[SPClientPeoplePicker.DisplayTextProperty] = g;
        a[SPClientPeoplePicker.SubDisplayTextProperty] = f;
        a[SPClientPeoplePicker.TitleTextProperty] = d;
    ...
    SPClientPeoplePickerProcessedUser.prototype = {
        ...
        UpdateSuggestions: function(b) {
            ...
            if (b.Description != null )
                this.ErrorDescription = b.Description
        },
        BuildUserHTML: function() {
            a: ;var a = []
              , c = SPClientPeoplePickerProcessedUser.BuildUserPresenceHtml(this.PresenceElementId, this.SIPAddress, this.ResolvedUser);
            a.push('<span data-sp-peoplePickerProcessedUser="true" id="');
            a.push(STSHtmlEncode(this.UserContainerElementId));
            a.push('" ResolvedUser="');
            a.push(this.ResolvedUser ? "true" : "false");
            a.push('" SID="');
            a.push(STSHtmlEncode(this.SID));
            a.push('" class="sp-peoplepicker-userSpan">');
            a.push('<span class="sp-peoplepicker-userPresence" id="');
            a.push(STSHtmlEncode(this.PresenceElementId));
            a.push('">');
            a.push(c);
            a.push("</span>");
            a.push('<span class="');
            a.push(this.ResolvedUser ? "ms-entity-resolved" : "ms-entity-unresolved");
            a.push('" id="');
            a.push(STSHtmlEncode(this.DisplayElementId));
            a.push('" title="');
            a.push(STSHtmlEncode(this.DisplayName));
            a.push('">');
        ...
        UpdateUserMaxWidth: function() {
            a: ;var a = document.getElementById(this.DisplayElementId);
            if (a != null ) {
                var b = SPClientPeoplePicker.PickerObjectFromSubElement(a)
                  , c = document.getElementById(b.TopLevelElementId);
                a.style.maxWidth = (c.clientWidth - 65).toString() + "px"
            }
        },
        ResolvedAsUnverifiedEmail: function() {
            a: ;if (!this.ResolvedUser || this.UserInfo == null )
                return false;
            var a = this.UserInfo;
    ...
    SPClientPeoplePickerProcessedUser.GetUserContainerElement = function(b) {
        var a = b;
        while (a != null && a.nodeName.toLowerCase() != "body") {
            if (a.getAttribute("data-sp-peoplePickerProcessedUser") == "true")
                return a;
            a = a.parentNode
        }
        return null
    ...
    SPClientPeoplePickerMRU.GetSPClientPeoplePickerMRU = function() {
        a: ;if (g_SPClientPeoplePickerInstance == null )
    ...
    SPClientPeoplePickerMRU.prototype = {
        ...
        MRUData: null ,
        GetItems: function(b) {
            if (b == null || b == "" || !this.isCacheAvailable)
                return [];
        ...
        SetItem: function(b, a) {
            if (b == null || b == "" || a == null || !this.isCacheAvailable)
                return;
            var d = b.toLowerCase()
              , e = a.Key.toLowerCase();
            if (this.MRUDataDict[e] != null )
                return;
            a.LocalSearchTerm = d;
            this.InsertCacheItem(a);
            var c = JSON.stringify(this.MRUData)
              , f = window.localStorage;
            f.setItem(SPClientPeoplePickerMRU.PPMRUDomLocalStoreKey, c)
        },
        InsertCacheItem: function(a) {
            ...
            if (c == SPClientPeoplePickerMRU.MaxPPMRUItems) {
                ...
                c < SPClientPeoplePickerMRU.MaxPPMRUItems && this.MRUData.dataArray.push(a);
            this.MRUDataDict[a.Key.toLowerCase()] = a
        },
        ResetCache: function() {
            a: ;if (!this.isCacheAvailable)
                return;
            var a = window.localStorage;
            a.removeItem(SPClientPeoplePickerMRU.PPMRUDomLocalStoreKey);
            this.MRUDataDict = {};
            this.MRUData = new SPClientPeoplePickerMRUData
        },
        EnsurePPMRUData: function() {
            a: ;if (!window.localStorage)
                return false;
...
function SPClientPeoplePicker_CallbackPopulateAutoFillFromEditor(b) {
    ...
    a.ExecutePickerQuery([d], function(j, h) {
        ...
        if (a.ShowingLocalSuggestions()) {
            ...
            a.ShowAutoFill(SPClientPeoplePicker.BuildAutoFillMenuItems(a, g))
    }, function() {
        a: ;a.SetServerError()
    }, null )
}
function SPClientPeoplePicker_CallbackOnAutoFillClose(e, b) {
    ...
    if (b != null ) {
        var d = c.value;
        if (a.UnresolvedUserElmIdToReplace != "")
            d = a.ProcessedUserList[a.UnresolvedUserElmIdToReplace].DisplayName;
        if (a.UnresolvedUserElmIdToReplace == "")
            c.value = "";
        b.IsResolved = true;
...
function SPClientPeoplePicker_OnEditorFocus(f) {
    ...
    if (b != null )
        b.className += " sp-peoplepicker-topLevelFocus";
    var c = document.getElementById(a.WaitImageId);
    if (b != null && c != null ) {
        c.style.top = "4px";
        if (fRightToLeft)
            c.style.right = (b.offsetWidth - 22).toString() + "px";
        else
            c.style.left = (b.offsetWidth - 22).toString() + "px"
    }
...
function SPClientPeoplePicker_OnEditorKeyDown(c) {
    ...
    var e = GetEventKeyCode(c)
      , a = GetEventSrcElement(c)
      , d = false
      , b = SPClientPeoplePicker.PickerObjectFromSubElement(a);
    if (b == null )
        return !d;
    if (c.ctrlKey && e == 75) {
        d = true;
        b.CloseAutoFill();
        b.AddUnresolvedUserFromEditor(false);
        b.ResolveAllUsers(null )
    } else if (e == 9) {
        var i = c.shiftKey;
        if (i || !b.IsAutoFillOpen()) {
            b.CloseAutoFill();
        ...
        if (a.createTextRange != null ) {
            ...
            if (f != null && f.text.length == 0) {
                ...
                if (f.text == "")
                    ...
                    h = a.value.lastIndexOf(f.text);
                g = h == 0 ? true : false
            }
        } else if (a.selectionStart == 0 && a.selectionEnd == a.selectionStart)
            g = true;
        g && b.DeleteProcessedUser(null )
    } else if (e == 13)
        d = true;
    else
        a.size = Math.max(a.value.length + 1, 1);
    d && CancelEvent(c);
    return !d
}
function SPClientPeoplePicker_OnEditorKeyUp(b) {
    ...
    if (a != null )
        a.size = Math.max(a.value.length, 1);
    var c = SPClientPeoplePicker.PickerObjectFromSubElement(a);
    if (c != null ) {
...
function SPClientPeoplePicker_BodyOnClickCloseAutoFill(d) {
    ...
    if (c.className.indexOf("ms-imn") != -1)
        return;
    if (a != null ) {
        var b = null ;
        if (c.className.indexOf("sp-peoplepicker-") != -1)
            b = SPClientPeoplePicker.PickerObjectFromSubElement(c);
...
function SPClientPeoplePickerProcessedUser(a, b, c) {
    ...
    if (a.Description != null )
        this.ErrorDescription = a.Description;
    if (a[SPClientPeoplePicker.ValueName] != null )
        this.SID = a[SPClientPeoplePicker.ValueName];
    if (a[SPClientPeoplePicker.DisplayTextName] != null )
        this.DisplayName = a[SPClientPeoplePicker.DisplayTextName];
    if (a.EntityData != null && a.EntityData[SPClientPeoplePicker.SIPAddressName] != null )
        this.SIPAddress = a.EntityData[SPClientPeoplePicker.SIPAddressName];
    if (a[SPClientPeoplePicker.SuggestionsName] != null && a[SPClientPeoplePicker.SuggestionsName].length > 0)
        this.Suggestions = a[SPClientPeoplePicker.SuggestionsName]
}
function SPClientPeoplePickerMRU() {
    a: ;this.isCacheAvailable = this.EnsurePPMRUData();
